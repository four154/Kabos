...
var me_user1 = setInterval(function () {
  if (myid != null) {
    ...
    $("#users .uzr:contains('كابوس')").addClass("stl1");
    ...
    $("div#users .uzr:contains('كابوس') .My_vedio1").click(function () {
      $("#movon1").show();
